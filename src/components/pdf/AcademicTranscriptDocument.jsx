				...
				<Page size='A4' style={styles.page}>
					...
					<View style={styles.header}>
						...
						<View style={styles.headerText}>
							...
							<Text style={styles.facultySubname}>
					...
					<View style={styles.coursesSection}>
						<Table style={styles.table} weightings={[10, 15, 12, 40, 13, 10]}>
							<TH>
							...
							<TR>
								...
								>
									{academicSummary.weighted_average
										? academicSummary.weighted_average.toFixed(1)
										: '0.0'}
								</TD>
							</TR>
						</Table>
