...
export const ApplicationDataDocument = ({
	applicationData,
	academicDegrees,
}) => {
	...
	const motherLastName = nameParts.slice(2).join(' ') || '';
		...
		<PDFViewer height='600' width='100%'>
			<Document>
				<Page size='A4' style={styles.page}>
					...
					<View
						style={[
							styles.inlineSection,
							{ alignItems: 'flex-start', gap: 16 },
						]}
					>
						<View style={{ width: '40%' }}>
							<Text style={{ textAlign: 'center', border: '1px solid #000' }}>
								{academicPeriod}
							</Text>
					...
					{/* Grados y títulos */}
					<View
						style={[styles.table, { display: 'flex', flexDirection: 'column' }]}
					>
						<View style={styles.tableRow}>
                  ...
                  <View style={[styles.tableCol, { width: '50%' }]}>
                    <Text style={styles.tableCell}></Text>
							...
							<View key={index} style={styles.tableRow}>
								<View style={[styles.tableCol, { width: '50%' }]}>
									<Text style={styles.tableCell}>{degree.name}</Text>
								</View>
								<View style={[styles.tableCol, { width: '50%' }]}>
									<Text style={styles.tableCell}>{degree.university}</Text>
								</View>
							</View>
						))}
					</View>
					...
					>
						...
						<View
							style={[styles.signatureBox, { width: '60%', marginTop: 24 }]}
						>
							<Text>Firma:</Text>
							<Text>
								Lima, {day} de {month} de {year}
							</Text>
						</View>
					</View>
					...
					<View style={styles.footer}>
						...
						>
							...
							<Text>
								Telefono: (511) 381-3826 - Central telefónica (511) 481-1070
								Anexo: 3401
							</Text>
