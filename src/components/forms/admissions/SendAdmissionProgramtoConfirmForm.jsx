					...
					{!item.modalities && (
						<Box>
							<Alert
								...
								title='¡Advertencia! No tiene ninguna modalidad asignada 💡'
							>
								El programa no tiene ninguna modalidad asignada. Asegúrate de
								asignar al menos una modalidad antes de enviar para aprobación.
							</Alert>
						</Box>
					)}
