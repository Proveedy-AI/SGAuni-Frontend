					...
					<Card.Body pt={4}>
						<SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} gap={3}>
							<Field label='Periodo de matrícula:'>
								<InputGroup
									w='100%'
									startElement={<FiCalendar color='#3182ce' />}
								>
									<Input
										readOnly
										ml='1'
							...
							<Field label='Monto total:'>
								<InputGroup
									w='100%'
									startElement={<FiDollarSign color='#38a169' />}
								>
									<Input
										readOnly
										ml='1'
						...
						{/*	<Field label='Amortización total:'>
							...
							<Field label='Saldo total:'>
								<InputGroup
									w='100%'
									startElement={<FiDollarSign color='#e53e3e' />}
								>
									<Input
										readOnly
										ml='1'
							...
							<Field label='Porcentaje de cuota inicial:'>
								<InputGroup
									w='100%'
									startElement={<FiPercent color='#805ad5' />}
								>
									<Input
										readOnly
										ml='1'
										variant='filled'
										bg='gray.50'
										value={item.upfront_percentage * 100}
									/>
								</InputGroup>
							</Field>*/}
							<Field label='N° de cuotas:'>
								<InputGroup w='100%' startElement={<FiHash color='#2b6cb0' />}>
									<Input
										...
										variant='filled'
										bg='gray.50'
										value={item.number_of_installments}
									/>
								</InputGroup>
							</Field>
							<Field label='Tipo de documento de pago:'>
								<InputGroup w='100%' startElement={<FiFile color='#718096' />}>
									<Input
										...
										variant='filled'
										bg='gray.50'
										value={item.payment_document_type_display}
									/>
								</InputGroup>
							</Field>
							<Field label='Estado:'>
								<Badge
									colorPalette={matchStatus?.color || 'gray.800'}
									px={3}
									py={1}
									borderRadius='md'
									fontWeight='semibold'
						...
						<SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} gap={5}>
							<Field label='Número de documento:'>
								<InputGroup
									w='100%'
									flex='1'
									startElement={<FiHash color='#2b6cb0' />}
								>
									<Input
										readOnly
										ml='1'
										variant='filled'
										bg='gray.50'
										value={item.num_document_person}
									/>
								</InputGroup>
							</Field>
