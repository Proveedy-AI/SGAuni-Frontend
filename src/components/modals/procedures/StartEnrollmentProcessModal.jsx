...
export const StartEnrollmentProcessModal = ({
	enrollment,
	onStartEnrollment,
}) => {
				...
				<Card.Root py={4}>
					...
					<Card.Body spaceY={3}>
						<Text fontSize='sm' color='gray.600' textAlign={'justify'}>
							Estás a punto de iniciar el proceso de matrícula para el programa{' '}
						...
						>
							...
							<Stack as='ol' gap={1} pb={8}>
								...
								<Text fontSize='sm' color='blue.900'>
									3. Revisa el resumen para verificar los créditos y el monto
