...
import { useCreateEnrollmentsPrograms } from '@/hooks/enrollments_programs';
import {
...
export const UpdateTuitionProgramsModal = ({
        ...
        if (open) {
            if (data) {
                ...
                setFormData({
                    ...
                    semesterStart: data.semester_start_date || '',
                });
            } else {
                setFormData({
                    academicPeriod: '',
    ...
    const handleSave = () => {
        ...
        if (actionType === 'create') {
            const payload = {
                name: formData.academicPeriod,
                admission_process_program: 18,
                enrollment_period: 0, // data.id,
                ...
                semester_start_date: formData.semesterStart,
