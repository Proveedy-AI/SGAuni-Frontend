...
export const AccountProfile = () => {
  ...
  return (
    <Box spaceY='5'>
      ...
      <VStack bg={{ base: 'white', _dark: 'uni.gray.500' }} p='6' align='start' borderRadius='10px' overflow='hidden' boxShadow='md' gap='6'>

        <ChangeProfileControl profile={profile} isChangesMade={isChangesMade} handleUpdateProfile={handleUpdateProfile} loadingUpdate={loadingUpdate} />
        
        <ChangeDataProfileForm user={user} profile={profile} updateProfileField={updateProfileField} />

        <ChangePasswordForm isOpen={isOpen} setIsOpen={setIsOpen} handleChangePassword={handleChangePassword} loadingPassword={loadingPassword} passwords={passwords} updatePasswordField={updatePasswordField} />
