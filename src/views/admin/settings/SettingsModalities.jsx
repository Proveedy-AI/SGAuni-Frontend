...
import { Box, Heading, Stack, Tabs, HStack, Input } from '@chakra-ui/react';
...
export const SettingsModalities = () => {
	...
	const { data: dataModalityRules, refetch: fetchModalityRules } =
			...
			>
				...
				<Tabs.Content value={2}>
					<Stack>
							...
							<HStack>
								<InputGroup flex='1' startElement={<FiSearch />}>
									<Input
										...
										onChange={(e) =>
											setSearchModalityRulesValue(e.target.value)
										}
									/>
								</InputGroup>
							</HStack>
						...
						<ModalityRulesTable
							isLoading={isLoading}
							data={filteredModalityRules}
							fetchData={fetchModalityRules}
						/>
					</Stack>
				</Tabs.Content>
			</Tabs.Root>
