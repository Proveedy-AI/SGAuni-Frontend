        ...
        <Card.Body>
          <Card.Root>
            <Card.Header>
              ...
              <Card.Description>
                Completa los datos para solicitar tu reintegración al programa académico.
                El administrador revisará tu solicitud y generará la orden correspondiente.
              </Card.Description>
              
              <Alert status='info' Icon={<FiAlertTriangle />}>
                <Text>
                  La reintegración te permite volver a incorporarte al programa después de una postergación.
                </Text>
                <List.Root pl='4' mt='2'>
                  <List.Item>Se evaluarán tus condiciones académicas y financieras</List.Item>
                  <List.Item>No debes tener deudas pendientes con la universidad</List.Item>
                  <List.Item>Debes estar en estado de &quot;postergación&quot; previamente</List.Item>
                </List.Root>
              </Alert>
            </Card.Header>
            ...
            <Card.Body>
              <VStack gap={6} align='stretch'>
                ...
                <SimpleGrid columns={{ base: 1, md: 2 }} gap={4}>
                  ...
                  >
                    <Input
                      value={enrollment ? `${enrollment.program_name} - ${enrollment.program_period}` : 'Cargando...'}
                      readOnly
                      variant='flushed'
                      bg='gray.50'
                      color='gray.600'
                  ...
                  >
                    <Input
                      value={selectedPaymentRule ? selectedPaymentRule.payment_purpose_name : 'Cargando...'}
                      readOnly
                      variant='flushed'
                      bg='gray.50'
                      color='gray.600'
                ...
                <Alert status='info' Icon={<FiAlertTriangle />}>
                  Tu solicitud de reintegración será enviada al Administrador de Cobranzas para
                  revisión. Recibirás una notificación cuando la orden sea generada.
                </Alert>
