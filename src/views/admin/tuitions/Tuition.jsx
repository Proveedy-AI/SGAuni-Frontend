...
import { Box, Button, Heading, Input, InputGroup, Stack } from "@chakra-ui/react"
...
export const Tuition = () => {
    ...
    return (
        <Box spaceY='5'>
            <Heading size={{ xs: 'xs', sm: 'sm', md: 'md' }}>Procesos de Matrícula</Heading>
            ...
            >
                <Stack 
                    ...
                    flex={1}
                >
                    <InputGroup startElement={<FiSearch />} flex={1} minW={'240px'} maxW={'400px'}>
                        <Input
                            size='sm'
                            bg={'white'}
                            maxWidth={'450px'}
                ...
                <Button
                    ...
                    borderRadius='6px'
                >
                    <FiPlus color='white' /> <div style={{ marginRight: 3, marginBottom: 2 }}>Crear período</div>
                </Button>
            </Stack>
