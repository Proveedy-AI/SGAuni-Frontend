...
import { useReadAcademicTranscript, useReadCoursesByPeriod } from '@/hooks/students';
...
export const AcademicSummaryCard = () => {
  return (
    <Card.Root mx='auto' bg='white' borderRadius='lg'>
      <Card.Header py={4} bg='blue.50' borderBottom='1px solid' borderColor='blue.200'>
        ...
        <Flex gap={8}>
          <VStack flex={1} spacing={6} align='stretch' maxW="30%">
            ...
            <VStack spacing={2} align='stretch' mt={4} pl={4}>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- Obligatorios</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>201</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- De Especialidad</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>0</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- Electivos Generales</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>4</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- Electivos de Especialidad</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>0</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- Optativos</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>0</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- Alternativos</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>0</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- De Otra Especialidad</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>0</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- Más de una vez</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>0</Badge>
              </HStack>
              <HStack justify='space-between'>
                <Text fontSize='sm' color='blue.500'>- Otros</Text>
                <Badge colorScheme='teal' variant='outline' size='sm'>0</Badge>
              </HStack>
            </VStack>
            ...
            <HStack borderTop='1px solid' borderColor='gray.200' pt={5} justify='space-between' align='center'>
          ...
          <VStack spacing={3} align='stretch' maxW="full">
            ...
            <VStack spacing={2} align='stretch'>
              ...
              <HStack spacing={3} p={3} bg='green.50' borderRadius='md' border='1px solid' borderColor='green.200'>
                <Box
                  w={3}
                  h={3}
                  bg='green.500'
              ...
              <HStack spacing={3} p={3} bg='blue.50' borderRadius='md' border='1px solid' borderColor='blue.200'>
                <Box
                  w={3}
                  h={3}
                  bg='blue.500'
              ...
              <HStack spacing={3} p={3} bg='gray.100' borderRadius='md' border='1px solid' borderColor='gray.300'>
                <Box
                  w={3}
                  h={3}
                  bg='gray.400'
...
export const MyCoursesListByAcademicPeriodView = () => {
  ...
  } = useReadAcademicTranscript(studentUUID);
  ...
  const isDownloadable = 
    (!isLoadingAcademicTranscript && !isLoading)
    ...
    <Box p={6} maxW='full' mx='auto'>
      ...
      <Heading my={3}>
        ...
        >
          ...
          <GenerateAcademicTranscriptPdfModal data={dataAcademicTranscript} isActive={isDownloadable} />
        </Stack>
      </Heading>
