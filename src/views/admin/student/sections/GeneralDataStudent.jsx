							...
							<VStack align='stretch' gap={4}>
								<Flex gap={3} align='start'>
									<Box>
										...
										<Text color='gray.900'>{dataPerson?.phone || '—'}</Text>
									</Box>
								</Flex>
								<Flex gap={3} align='start'>
									<Box>
							...
							<VStack align='stretch' gap={4}>
								...
								<Flex gap={3} align='start'>
									<Box>
										...
										<Text color='gray.900'>{dataPerson?.address || '—'}</Text>
									</Box>
								</Flex>
							</VStack>
						</Card.Body>
								...
								<Flex gap={3} align='start'>
									<Box>
										...
										<Text>
											<Badge
												colorPalette={
													dataPerson?.scholarshipInterest ? 'green' : 'red'
												}
												px={2}
												py={1}
												fontSize='sm'
								...
								<Flex gap={3} align='start'>
									<Box>
										...
										<Text>
											<Badge
												colorPalette={
													dataPerson?.acceptsDataProcessing ? 'green' : 'red'
												}
												px={2}
												py={1}
												fontSize='sm'
